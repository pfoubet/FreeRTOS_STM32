...
osThreadId GUIPointerThreadHandle;
...
static void GUIPointer_Thread(void const *argument);
...
//  /***********************************************************/
//
//   /* Compute the prescaler value to have TIM3 counter clock equal to 10 Hz */
//   /* (20Hz interrupt) */
...
//
  ...
  /* GUI Thread definition */
  osThreadDef(GUI, GUI_Thread, osPriorityNormal, 0, configMINIMAL_STACK_SIZE * 4);
  /* Start GUI thread */
  GUIThreadHandle = osThreadCreate (osThread(GUI), NULL);

  /* GUI Thread definition */
  osThreadDef(POINTER, GUIPointer_Thread, osPriorityNormal, 0, configMINIMAL_STACK_SIZE );
  /* Start GUI thread */
  GUIPointerThreadHandle = osThreadCreate (osThread(POINTER), NULL);
...
/**
  * @brief  GUI pointer thread (touch screen)
  * @param  None
  * @retval None
  */
static void GUIPointer_Thread(void const *argument)
